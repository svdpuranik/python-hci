...
class OpCode(IntEnum):
    ...
    HCI_LE_ENHANCED_CTE_RECEIVER_TEST=0x204F
    HCI_LE_ENHANCED_CTE_TRANSMITTER_TEST=0x2050
    HCI_LE_SET_CONNECTION_CTE_RECEIVE_PARAMS=0x2054
    HCI_LE_SET_CONNECTION_CTE_TRANSMIT_PARAMS=0x2055
    HCI_LE_SET_CONNECTION_CTE_REQUEST_ENABLE=0x2056
    HCI_LE_SET_CONNECTION_CTE_RESPONSE_ENABLE=0x2057
    HCI_LE_READ_ANTENNA_INFORMATION=0x2058
